    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <i class="fglyphicon glyphicon-plus"></i> Agregar nuevo recurso                
            </div>
            {{ HTML::ul($errors->all()) }}
            {{ Form::open(array('url' => 'recursos')) }}     
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-lg-offset-3">              
                        ...
                        <div class="form-group">
                            ...
                            {{Form::number('cantidad', Input::old('cantidad'), array('class' => 'form-control input-xlarge', 'required' => 'true'))}}                      
                        </div>

                       <div class="form-group">
                            {{ Form::label('medidaid', 'Unidad Medida') }}
                            {{ Form::select('medidaid', $medidas, null, array('class' => 'form-control')) }}                             
                        </div>            
